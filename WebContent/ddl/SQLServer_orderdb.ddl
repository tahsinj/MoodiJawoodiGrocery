...
INSERT INTO category(categoryName) VALUES ('Spices and Seasonings');
INSERT INTO category(categoryName) VALUES ('Grains and Pulses');
INSERT INTO category(categoryName) VALUES ('Oils and Sauces');
INSERT INTO category(categoryName) VALUES ('Dried Fruits and Nuts');
INSERT INTO category(categoryName) VALUES ('Sweets and Desserts');
INSERT INTO category(categoryName) VALUES ('Breads and Pastries');
INSERT INTO category(categoryName) VALUES ('Teas and Beverages');
INSERT INTO category(categoryName) VALUES ('Dairy and Cheese');

INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chai', 7, '10 boxes x 20 bags',2);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Coriander',1,'24 - 12 oz containers',19.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Basmati Rice',2,'3.62 kg bags',10.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Lentils',2,'48 - 6 oz jars',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Barley',2,'36 boxes',21.35);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chickpeas',2,'12 - 8 oz jars',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Dates',4,'12 - 1 lb pkgs.',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Couscous',2,'12 - 12 oz jars',40.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Baklava',5,'18 - 500 g pkgs.',97.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pita Bread',6,'12 - 200 ml jars',31.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pomegranate Molasses',3,'1 kg pkg.',21.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Tahini',3,'10 - 500 g pkgs.',38.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pistachios',4,'40 - 100 g pkgs.',23.25);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Kidney Beans',2,'24 - 250 ml bottles',15.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Hibiscus',7,'32 - 500 g boxes',17.45);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Maamoul Cookies',5,'20 - 1 kg tins',39.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Lavash',6,'16 kg pkg.',62.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Rose Water',7,'10 boxes x 12 pieces',9.20);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Mint Tea',7,'30 gift boxes',81.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Tamarind Juice',7,'24 pkgs. x 4 pieces',10.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Labneh',8,'24 - 500 g pkgs.',21.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Zaatar',1,'24 - 12 oz bottles',14.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Turmeric',1,'24 - 12 oz bottles',18.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Samosas',6,'24 - 250 g  jars',19.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Fatayer',6,'24 - 4 oz tins',18.40);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Knafeh',6,'12 - 12 oz cans',9.65);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Feta Cheese',8,'32 - 1 kg pkgs.',14.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Bulgur',2,'32 - 8 oz bottles',21.05);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Sumac',1,'24 - 12 oz bottles',14.00);
